...
var base58encode = bitcore.encoding.Base58.encode;
...
Router.prototype.id = function() {
  if(!this._id) {
    this._id = base58encode(sha256ripe160(this.key.publicKey));
  } 
  return this._id;
};
